...
//모든 컨트롤러에서 사용자명을 저장할 수 있도록 aop로 구현 (로그인할때 나의 닉네임뜨는 aop)
...
public class AuthAspect {
	...
	public Object checkSesstion(ProceedingJoinPoint joinpoint) throws Throwable{
		...
		//auth.getPrincipal(); 로그인 하지 않았을 경우 스피링 시큐리티가 auth.getPrincipal() 메서드의 반환값으로
		//anonymousUser 를 반환함.. 따라서 조건문을 처리해야 함
