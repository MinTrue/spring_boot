...
public class MemberController {
	...
	public String join(Member member) {
		...
		System.out.println("member uid "+member.getEmail());
		System.out.println("member uid "+member.getNickname());
		System.out.println("member uid "+member.getSns().getSns_name());
	...
	public ModelAndView kakaoCallback(HttpServletRequest request) {
		...
		System.out.println("카카오가 보내 임시 코드는 "+code);
		...
		String body = responseEntity.getBody();
		System.out.println("카카오가 보낸 토큰을 포함한 응답정보는 "+body);
		...
		System.out.println("카카오가 보낸 사용자 정보는 "+body2);
